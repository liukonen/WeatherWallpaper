    ...
    internal class OpenWeatherAPIBase :ISharedInterface
    {
      //&units=imperial //&units=metric
       ...
       public int UpdateInterval
        ...
        {
            APIKey = WeatherDesktop.Share.SharedObjects.InputBox("Please enter the API key provided by openweathermap.org", "Enter API");
        ...
        {
            int DumbyValue = 60;
            if (int.TryParse(SharedObjects.InputBox("Enter New interval between 10 and 120", "Update Interval Minutes", UpdateInterval.ToString()), out DumbyValue))
            {
