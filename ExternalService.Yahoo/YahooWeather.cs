...
namespace InternalService
{
    ...
    public class YahooWeather : ISharedWeatherinterface
    {
        ...
        {
            UpdateInterval = int.Parse(WeatherDesktop.Shared.SharedObjects.InputBox("Please enter a update time value in minutes, between 10 and 120", "Yahoo Update Interval", _HardWiredUpdateInterval.ToString()));
